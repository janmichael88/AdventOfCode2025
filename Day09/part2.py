'''
given list of x,y points, make the largest rectagle
but whatever rectangble we pick, all the cells must be red or green
i dont think we can check all i,j in the ranges of all potential rectangles
the issue is how to check that all the cells in my recatangle are filled
think of the 1d problem, straight line, the answerr would just be the longest range, after merging of course
no idea on day 9 or would be day 18 :(
'''
